    ...
    getLot: (name: keyof typeof constant.Lot) => {
      ...
      switch (name) {
        case 'FORTUNE': {
          ...
          result = asc.ascendant + (isDiurnal ? moon.position.longitude.absolute - sun.position.longitude.absolute : sun.position.longitude.absolute - moon.position.longitude.absolute);
          break;
        }
        case 'SPIRIT': {
          const isDiurnal = hse.isDiurnal();
          ...
          result = asc.ascendant + (isDiurnal ? sun.position.longitude.absolute - moon.position.longitude.absolute : moon.position.longitude.absolute - sun.position.longitude.absolute);
          break;
        }
      };
